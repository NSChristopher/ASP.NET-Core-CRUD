...
namespace ASP.NET_Core_CRUD.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,JokeQuestion,JokeAnswere")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokeQuestion,JokeAnswere")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
